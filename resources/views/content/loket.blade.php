                ...
                <div class="tab-content tabcontent-border">
                        ...
                        <div class="p-20">
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Vechile Number</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="datepicker-autoclose" class="form-control" id="password" placeholder="Vechile Number Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                    ...
                    <div class="tab-pane " id="profile" role="tabpanel">
                        <div class="p-20">
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Personal Info 2</h4>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="datepicker-autoclose" class="form-control" id="password" placeholder="Password Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
